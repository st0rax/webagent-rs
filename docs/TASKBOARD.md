...
| T-916 | API-Bridge-Prompt- und Tool-Normalizer isolieren | claimed `grok-agent` / `refactor/T-916-api-bridge-content` |
...
T-914 und T-919 bleiben frei. T-915 done, T-916 claimed (`grok-agent`).
