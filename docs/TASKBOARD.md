...
T-914 bleibt frei/deferred. T-919 claimed (`grok-agent` / `feature/T-919-wire-inference`). T-915–T-918 done (`grok-agent`).
...
User-Skips: **T-914** bleibt deferred (nicht claimen). T-919 claimed (`grok-agent`).
