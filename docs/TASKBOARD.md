...
| T-917 | API-Bridge-Modellkatalog und Auto-Router isolieren | claimed `grok-agent` / `refactor/T-917-api-bridge-catalog` |
...
T-914 und T-919 bleiben frei. T-917 claimed (`grok-agent`).
