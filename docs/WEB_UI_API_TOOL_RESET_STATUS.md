...
`src/api_bridge/provider_handlers.rs`. `src/api_bridge.rs` bleibt unveraendert;
T-913 verdrahtet das Modul. Gates: fmt/clippy `-D warnings`/50 `api_bridge::tests` gruen.
Beweis: `docs/proofs/T-908/`.

## Vorher: 2026-09-13, T-907 Routing-Modul
